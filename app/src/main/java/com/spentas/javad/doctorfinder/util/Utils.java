...
public class Utils {
    ...
    public static boolean isConnected(){
        ...
        Logger.i((isConnected || isConnected_by_wifi) ? String.format("Connected by using 3G=%b || wifi=%b ", isConnected, isConnected_by_wifi) : "Disconnected");

        return isConnected_by_wifi;
    }
}